    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                    @if(\Helper::roleChecker('translate.index'))  <li><a target="_blank" href="/admin/translations"> <i class="menu-icon fa fa-font"></i>Tərcümələr </a></li>   @endif
                        <li ><a href="{{route('dashboard')}}"><i class="menu-icon fa fa-laptop"></i>Panel </a></li>

                <li class="menu-title">ƏSAS</li><!-- /.menu-title -->

                @if(\Helper::roleChecker('page.index'))  <li><a href="{{route('page.index')}}"> <i class="menu-icon fa fa-file"></i>Səhifələr </a></li>   @endif
                @if(\Helper::roleChecker('page.index'))  <li><a href="{{route('contact.index')}}"> <i class="menu-icon fa fa-file"></i> Əlaqə məlumatları
                            </a></li>   @endif
                @if(\Helper::roleChecker('menu.index'))  <li><a href="{{route('menu.index')}}"> <i class="menu-icon fa fa-list"></i>Menu </a></li>   @endif

                <li><a href="{{route('vacancy-apply.index')}}"> <i class="menu-icon fa fa-list"></i> Vakansiyaya Müraciət Edənlər </a></li>




                @if(\Helper::roleChecker('article.index'))
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            @foreach(config_json('article-types.articles') as $type => $template)
                                <li><a href="{{route('article.index',['type' => $type, 'category' => 'articles'])}}">{{__('backend.'.$type)}}</a></li>
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            @foreach(config_json('article-types.video') as $type => $template)
                                <li><a href="{{route('article.index',['type' => $type, 'category' => 'video'])}}">{{__('backend.'.$type)}}</a></li>
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    ...
                                    @foreach(config_json('article-types.brifing') as $type => $template)
                                        <li><a href="{{route('article.index',['type' => $type, 'category' => 'brifing'])}}">{{__('backend.'.$type)}}</a></li>
                ...
                @endif
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                @if(\Helper::roleChecker('vacancy.index'))  <li><a href="{{route('vacancy.index')}}">Təcrübə Proqramı</a></li>@endif
...
{{--                <li class="menu-title">Əlavə</li><!-- /.menu-title -->--}}
                ...
                <li><a href="{{route('cache.clear')}}"><i class="menu-icon fa fa-broom"></i> Keşi Təmizlə</a></li>
                <li><a href="{{route('settings-app.index')}}"><i class="menu-icon fa fa-sliders-h"></i> Ayarlar</a></li>

                @if(\Helper::roleChecker('role.index') || \Helper::roleChecker('rolpermissione.index'))
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        @if(\Helper::roleChecker('admin-users.index'))  <li><a href="{{route('admin-users.index')}}">İstifadəçilər</a></li>@endif
                        @if(\Helper::roleChecker('role.index')) <li><a href="{{route('role.index')}}">Rollar</a></li>@endif
                        @if(\Helper::roleChecker('permission.index')) <li><a href="{{route('permission.index')}}">Səlahiyyətlər</a></li>@endif

                    </ul>
                </li>
                @endif

                @if(\Helper::roleChecker('template.index'))
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        @if(\Helper::roleChecker('template.index'))  <li><a href="{{route('template.index')}}">Şablonlar</a></li>@endif
                        @if(\Helper::roleChecker('simple-json.index'))  <li><a href="{{route('simple-json.index')}}">Sadə Elementlər</a></li>@endif
                        @if(\Helper::roleChecker('article-types.index'))  <li><a href="{{route('article-types.index')}}">Paylaşım Kateqoriyaları</a></li>@endif
            ...
            <div class="header-menu">
                ...
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <p class="m-0 d-flex align-items-center p-3">{{ auth('admin')->user()->name }}</p>
                    ...
                    <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="{{ route('logout') }}"  onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="fa fa-power -off"></i> Sistemdən çıxış</a>
