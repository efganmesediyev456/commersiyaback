                                        ...
                                        <div class="tab-pane fade @if($loop->iteration == 1) active show @endif" id="tab-{{$loop->iteration}}" role="tabpanel" aria-labelledby="pills-home-tab">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label  class=" form-control-label">Mövzu</label>
                                                    </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    @for($i = 0 ; $i < 5 ; $i++)
                                                        <input type="text"  name="answers[{{$lang}}][{{$i}}]" placeholder="" value="{{ $item->translate($lang)->answers->{$i} ?? old('answers.'. $lang .'.' . $i)}}" class="form-control mt-3">
                                                    @endfor
