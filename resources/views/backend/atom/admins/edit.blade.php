                            ...
                            <form action="{{route($routeName . '.update',$item->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" value="{{$item->name}}" name="name" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="email" id="text-input" name="email" value="{{$item->email}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="role_id" id="role_id" class="form-control">
                                            ...
                                            @foreach($roles as $rol)
                                                <option value="{{$rol->id}}"  @if($item->role_id == $rol->id) selected @endif >{{$rol->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
