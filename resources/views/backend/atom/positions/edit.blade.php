                                        ...
                                        <div class="col-12 col-md-9 pb-5 pt-5" style="display: flex; align-items: center">
                                            ...
                                            @if($item->icon)
                                                <div class="image-input">
                                                    <a class="open" target="_blank" href="{{ $item->icon }}"> <img  src="{{ $item->icon }}" alt=""></a>
                                                    <a href="{{route('remove-photo',['Position',$item->id,'icon','vacancy'])}}" class="remove-photo" ><i class="fa fa-trash size32"></i></a>
{{--                                                    <a href="{{route('remove-photo',['Article',$item->id,'image',$item->type])}}" class="remove-photo" onclick="if (!confirm('Silmək istədiyinizdən əminsiniz?')) { return false }"><i class="fa fa-trash size32"></i></a>--}}
                            ...
                            <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class=" form-control-label">Siralama</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <div class="form-check-inline form-check ">

                                            <input name="ordering" type="number" class="form-control" value="{{$item->ordering}}">
