<div class="content">
    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            ...
            <form method="post" action="/{{ config('app_settings.url') }}" class="form-horizontal d-flex  mb-3" style="flex-flow: row wrap" enctype="multipart/form-data" role="form">
                {!! csrf_field() !!}
