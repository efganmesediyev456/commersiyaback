                        ...
                        <div class="card-body card-block">
                            <form action="{{route($routeName . '.update',$item->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="model" placeholder="" value="{{$item->model}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="form-check-inline form-check">
                                            <label class="form-check-label mr-2">
                                                <input type="checkbox"  name="R" value="1" {{$item->R ? 'checked' : ''}} class="form-check-input ">Baxmaq
                                            </label>
                                            <label  class="form-check-label mr-2">
                                                <input type="checkbox"  name="C" value="1" {{$item->C ? 'checked' : ''}} class="form-check-input ">Əlavə etmək
                                            </label>
                                            <label class="form-check-label mr-2">
                                                <input type="checkbox"  name="U" value="1" {{$item->U ? 'checked' : ''}} class="form-check-input " >Redaktə etmək
                                            </label>
                                            <label  class="form-check-label mr-4">
                                                <input type="checkbox" name="D" value="1" {{$item->D ? 'checked' : ''}} class="form-check-input " >Silmək
                                            </label>
                                            <label class="form-check-label mr-2">
                                                <input type="checkbox" name="full" value="1" {{$item->full ? 'checked' : ''}} class="form-check-input " >Full
                                            </label>
                                        </div>
                                    </div>
                                </div>
