                            ...
                            <div class="div-w active ">
                                <div class="tabb">
                                    ...
                                    <div  style="width: 200px">
                                        ...
                                        @endif
                                        @if($p->id !== 1)
                                            <a class="badge btn mr-2 badge-warning p-0 copy-text-to-clipboard"  data-href="{{ config('app.url') . '/' . config('app.locale')}}/page/{{ slug($p->translate(config('app.fallback_locale'))->title ) }}"><i class="far fa-copy size32"></i></a>
                                        @endif
