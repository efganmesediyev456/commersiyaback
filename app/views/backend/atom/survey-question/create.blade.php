                                            ...
                                            <div class="tab-pane fade @if($loop->iteration == 1) active show @endif" id="tab-{{$loop->iteration}}" role="tabpanel" aria-labelledby="pills-home-tab">
                                                ...
                                                <div class="row form-group">
                                                        <div class="col col-md-3">
                                                            <label  class=" form-control-label">Sual</label>
                                                        </div>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label  class=" form-control-label">Cavablar</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab*" value="{{old('answers.'. $lang .'.0')}}" class="form-control">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab*" value="{{old('answers.'. $lang .'.1')}}" class="form-control mt-3">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab" value="{{old('answers.'. $lang .'.2')}}" class="form-control mt-3">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab" value="{{old('answers.'. $lang .'.3')}}" class="form-control mt-3">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab" value="{{old('answers.'. $lang .'.4')}}" class="form-control mt-3">
                                                        <input type="text"  name="answers[{{$lang}}][]" placeholder="Cavab" value="{{old('answers.'. $lang .'.5')}}" class="form-control mt-3">
                                                    </div>
