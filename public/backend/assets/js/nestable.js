...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        collapseBtnHTML: '<button class="dd-collapse btn btn-grey" data-action="collapse" type="button"></button>',
        group: 0,
        maxDepth: 5,
        threshold: 20,
    ...
    Plugin.prototype = {
        ...
        setParent: function(li) {
            ...
            if (li.is(this.options.itemNodeName) && li.children(this.options.listNodeName).length) {
               ...
               // console.log($(li[0].childNodes[1].childNodes[1]).prepend($(this.options.collapseBtnHTML)))
