...
<script src="<?php echo e(asset('backend/assets/js/jquery.matchHeight.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/nestable.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/moment.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('/backend/assets/vendor/ckeditor/ckeditor.js')); ?>"></script>
...
<?php /**PATH /Applications/MAMP/htdocs/commersiyaback/resources/views/backend/includes/footer.blade.php ENDPATH**/ ?>